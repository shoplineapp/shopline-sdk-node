...
class DeveloperOAuth {
  ...
  async insertTokenToSession(req, tokenData) {
    console.log('before insert token, token :>> ', req.session.accessTokens);
    ...
    console.log('after insert token, token :>> ', req.session.accessTokens);
    this.log('request', 'trace', {
  ...
  isSsoSessionChanged(req, currSsoSessionId) {
    console.log('prevSsoSessionId :>> ', req.session.prevSsoSessionId);
    console.log('currSsoSessionId :>> ', currSsoSessionId);
    console.log('req.session.prevSsoSessionId !== currSsoSessionId :>> ', req.session.prevSsoSessionId !== currSsoSessionId);
