...
class DeveloperOAuth {
  ...
  async authenticate(req, res, next) {
    try {
      ...
      const currentMerchantId = req.params.merchantId || req.params.merchant_id || req.query.merchant_id || this.getDefaultMerchantId(req);
      ...
      if (currentToken && this.isTokenExpired(currentToken)) {
        ...
        this.constructTokenData(oauthRes, performerId)
      ...
      if (!currentToken && !req.xhr) {
        ...
        req.session.afterAuthRedirectTo = req.session.afterAuthRedirectTo || res.locals.currentURL;
